...
<div id="input-form">
    ...
    <div id="form">
        ...
        <div class="input-item">
            <span class="input-title"><span class="star">*</span>反馈分类</span>
            <Select :data="feedBack" title="请选择反馈分类" v-model="feedBackId" style="width: 100%"/>
        </div>
        <div class="error"/>
        <div class="input-item">
...
export default {
    ...
    data() {
        return {
            ...
            title: "意见反馈",
            text: "为了更好倾听您的意见和建议，请填写以下信息，我们将尽快与您联系",
            content: [
                ...
                { title: "反馈描述", placeholder: "请填写您的意见和建议", data: "" },
            ],
            feedBack: [ "意见反馈分类 0", "意见反馈分类 1", "意见反馈分类 2" ],
            feedBackId: 0,
            cityId: [19, 0],
            verifyText: "获取",
            alertTitle: "已收到您的意见反馈",
            alertText: "我们将尽快与您联系",
        }
    },
}
