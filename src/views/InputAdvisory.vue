...
<div id="input-form">
    ...
    <div id="form">
        ...
        <div class="input-item">
            <span class="input-title"><span class="star">*</span>咨询方案</span>
            <Select :data="solution" title="请选择方案" v-model="solutionId" style="width: 100%"/>
        </div>
        <div class="error"/>
        <div class="input-item">
        ...
        <div class="input-item" style="height: 8rem">
            ...
            <textarea class="input" id="textarea" :placeholder="content[6].placeholder" v-model="content[6].data"></textarea>
        </div>
    ...
    data() {
        return {
            ...
            content: [
                ...
                { title: "场景描述", placeholder: "请描述所需应用场景", data: "" },
                { title: "咨询问题", placeholder: "请大致描述您的问题，以便开展下一步工作", data: "" },
            ],
            solution: [ "解决方案 0", "解决方案 1", "解决方案 2" ],
            solutionId: 0,
            cityId: [19, 0],
            verifyText: "获取",
            alertTitle: "已收到您的咨询",
